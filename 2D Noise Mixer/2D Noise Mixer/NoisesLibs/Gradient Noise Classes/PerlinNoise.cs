...
/// Found at https://gist.github.com/Flafla2/f0260a861be0ebdeef76
/// </summary> 
/// 
...
namespace NoiseMixerLib
{
    ...
    public class PerlinNoise
    {
        ...
        public int SetRepeat { set { repeat = value; } }
        ...
        /// <returns>Double between 0,1 if normalize, else between -1,1. </returns>
        public double Perlin(double x, double y, double z, bool NormalizeReturn = true)
        {
            if (repeat > 0)
